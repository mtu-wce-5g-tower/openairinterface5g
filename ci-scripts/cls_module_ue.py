...
#-----------------$
	...
	def check(self):
		if self.cmd_dict["check"]:
			return self._command(self.cmd_dict["check"])
		else:
	...
	def dataEnable(self):
		if self.cmd_dict["dataEnable"]:
			return self._command(self.cmd_dict[""])
		else:
